class SeedRescheduleNotificationTypeJob < ApplicationJob
  ...
  def seed_template(apt_type)
    case apt_type&.name
    when 'RDV de suivi SAP', "Sortie d'audience SAP"
      ...
      "Pensez à apporter votre pièce d'identité et vos justificatifs. "\
      'En cas de besoin, vous pouvez contacter le {lieu.téléphone}.'
    ...
    when '1er rdv SPIP', 'Rdv de Suivi SPIP', "Sortie d'audience SPIP", 'Convocation 741-1'
