...
place_spip_37_tours = Place.find_or_create_by!(organization: org_spip_37_tours, name: "SPIP 37 - Tours", adress: "2 rue Albert Dennery BP 2603, 37000 Tours", phone: '0606060606')
place_tj_tours = Place.find_or_create_by(organization: org_tj_tours, name: "TJ Tours", adress: "2 PLACE JEAN-JAURES 37928 Tours", phone: '0606060606')
