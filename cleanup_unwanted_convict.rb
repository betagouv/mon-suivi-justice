...
csv_data = CSV.read(input_file, headers: true, col_sep: ';', external_encoding: 'iso-8859-1',
                                internal_encoding: 'utf-8')

filtered_data = csv_data.reject do |row|
  row['Affectation SPIP'].nil? || row['Affectation SPIP'].strip.empty? ||
    ['EMPRISONNEMENT', 'AMÉNAGEMENT DE PEINE',
...
CSV.open(output_file, 'w', col_sep: ';', write_headers: true, headers: csv_data.headers,
