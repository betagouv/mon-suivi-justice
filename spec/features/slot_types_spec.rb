...
RSpec.feature 'SlotTypes', type: :feature do
  ...
  describe 'edition' do
    ...
    it 'does not edit a slot_type with attributes that already exists' do
      slot_type = create(:slot_type, week_day: 'monday', starting_time: Time.zone.now.beginning_of_day + 14.hours,
                                     duration: 30, capacity: 1, appointment_type: @appointment_type, agenda: @agenda)
      create(:slot_type, week_day: 'monday', starting_time: Time.zone.now.beginning_of_day + 15.hours, duration: 30,
  ...
  describe 'creation' do
    ...
    it 'does not create a slot_type that already exists' do
      create(:slot_type, starting_time: Time.zone.now.beginning_of_day + 14.hours, duration: 30, capacity: 10,
