...
RSpec.describe SlotFactory do
  ...
  describe '#perform' do
    it 'creates only tuesday and thursday slot' do
      ...
      tuesday_slot_type = create :slot_type, agenda: agenda, appointment_type: appointment_type,
                                             week_day: 'tuesday',
                                             starting_time: Time.zone.parse('2021-01-01 10:00:00')

      wednesday_slot_type = create :slot_type, agenda: agenda, appointment_type: appointment_type,
                                               week_day: 'wednesday',
                                               starting_time: Time.zone.parse('2021-01-01 09:00:00')

      thursday_slot_type = create :slot_type, agenda: agenda, appointment_type: appointment_type,
                                              week_day: 'thursday',
      ...
      expect(
        Slot.find_by(
          slot_type: tuesday_slot_type, agenda: agenda, appointment_type: appointment_type,
      ...
      expect(
        Slot.find_by(
          slot_type: thursday_slot_type, agenda: agenda, appointment_type: appointment_type,
      ...
      expect(
        Slot.find_by(
          slot_type: wednesday_slot_type, agenda: agenda, appointment_type: appointment_type,
    ...
    it 'creates slots only once with multiple perform' do
      create :slot_type, agenda: agenda, appointment_type: appointment_type,
                         week_day: 'tuesday',
                         starting_time: Time.zone.parse('2021-01-01 10:00:00')
      ...
      result = Slot.where(agenda: agenda, appointment_type: appointment_type, date: next_tuesday)
