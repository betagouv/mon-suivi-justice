...
RSpec.describe SlotTypeFactory do
  ...
  describe 'build_starting_times' do
    ...
    it 'creates array of starting times' do
      expected = [
        Time.new(2021, 6, 21, 9, 00, 0, timezone),
        Time.new(2021, 6, 21, 9, 15, 0, timezone),
        Time.new(2021, 6, 21, 9, 30, 0, timezone),
        Time.new(2021, 6, 21, 9, 45, 0, timezone),
        Time.new(2021, 6, 21, 10, 00, 0, timezone),
        Time.new(2021, 6, 21, 10, 15, 0, timezone),
        Time.new(2021, 6, 21, 10, 30, 0, timezone),
        Time.new(2021, 6, 21, 10, 45, 0, timezone),
        Time.new(2021, 6, 21, 11, 00, 0, timezone),
        Time.new(2021, 6, 21, 11, 15, 0, timezone),
        Time.new(2021, 6, 21, 11, 30, 0, timezone),
        Time.new(2021, 6, 21, 11, 45, 0, timezone),
        Time.new(2021, 6, 21, 12, 00, 0, timezone)
      ]

      result = SlotTypeFactory.build_starting_times(
        first_slot: Time.new(2021, 6, 21, 9, 00, 0, timezone),
        last_slot: Time.new(2021, 6, 21, 12, 00, 0, timezone),
        interval: 15
      )
